    ...
    <React.Fragment>
      ...
      >
        ...
        <p>
          ...
          under the URL www.Magic365.live&nbsp;(the “Website”) and its related
          or connected services (collectively, the “Service”) will be provided
          to you.{" "}
        </p>
        <br />
        <p>
        ...
        <p>
          {" "}
          It is the User’s responsibility to check and enter this site only if
          the user is in a country where it is lawful to place bets on the
          service (if in doubt, you should seek local legal advice). It is your
        ...
        <p>
          ...
          driver’s licence or national ID card) and a recent utility bill
          ...
          requirements. Additionally, you will need to fund your Magic365
        ...
        <p>
          ...
          advise Magic365 of any changes in their email address. Each Customer
          is wholly responsible for maintaining the security of his Registered
          Email Address to prevent the use of his Registered Email Address by
          any third party. Magic365 shall not be responsible for any damages or
          losses deemed or alleged to have resulted from communications between
          Magic365 and the Customer using the Registered Email Address. Any
          Customer not having an email address reachable by Magic365 will have
          his Account suspended until such an address is provided to us. We will
          immediately suspend your Account upon written notice to you to this
          effect if you intentionally provide false or inaccurate personal
          information. We may also take legal action against you for doing so in
          certain circumstances and/or contact the relevant authorities who may
        ...
        <p>
          ...
          from&nbsp;Magic365.live. These requests have to be received from the
        ...
        <p>
          ...
          Such request has to be sent from the Customer’s Registered Email
          Address. Implementation and increasing of limits shall be processed
          diligently, however, any request for removing or reducing limitations
          shall be done after a cooling-off period of seven days following your
          request.{" "}
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          converted using the daily exchange rate obtained
          from&nbsp;www.oanda.com, or at our own bank’s prevailing rate of
          exchange following which your Account will be deposited accordingly.{" "}
        </p>
        <br />
        <p>
          {" "}
          Fees and charges may apply to customer’s deposits and withdrawals. Any
          deposit made to an account which is not rolled over (risked) three
          times will incur a 3% processing fee and any applicable withdrawal
          fee. You are responsible for your own bank charges that you may incur
          due to depositing funds with us. Exceptions to this rule are outlined
          in our “Payment Options” pages.{" "}
        </p>
        <br />
        <p>
          Magic365 is not a financial institution and uses a third party
          ...
          payment issuing institution. If your card’s issuer gives no such
        ...
        <p>
          ...
          Magic365.live Account. We may, and always at our own discretion, allow
          you to withdraw to a payment method from which your original deposit
        ...
        <p>
          ...
          administration fee, or currency equivalent per charge-back, denial or
        ...
        <p>
          ...
          “Casino Error”), we reserve the right to declare null and void any
          wagers or bets that were the subject of such Casino Error and to take
          any money from your Account relating to the relevant bets or wagers.{" "}
        </p>
        <br />
        <p>
          {" "}
        ...
        <p>
          ...
          we attempt to include the letter “N” next to the team names to
          indicate this. For the Asian and mobile versions, we do not
        ...
        <br />
        <p>
          Magic365 reserves the right to remove events, markets and any other
          product from the website.
        </p>
        <br />
        <p>
          Magic365 eserves the right to restrict the casino access of any player
        ...
        <p>
          ...
          minimum number of games required for the future to have “action” has
          not been completed.{" "}
        </p>
        <br />
        ...
        <p>
          ...
          is not operated by Magic365, and must be given to and from the
        ...
        <p>
          ...
          SUPPLIERS COULD HAVE FORESEEN OR FORESTALLED EVEN IF WE OR THEY HAD
          TAKEN REASONABLE CARE. AS THIS SERVICE IS FOR CONSUMER USE ONLY WE
          WILL NOT BE LIABLE FOR ANY BUSINESS LOSSES OF ANY KIND.{" "}
        </p>
        <br />
        <p>
          {" "}
          IN THE EVENT THAT WE ARE HELD LIABLE FOR ANY EVENT UNDER THESE TERMS,
          OUR TOTAL AGGREGATE LIABILITY TO YOU UNDER OR IN CONNECTION WITH THESE
        ...
        <p>
          {" "}
          WE STRONGLY RECOMMEND THAT YOU (I) TAKE CARE TO VERIFY THE SUITABILITY
          AND COMPATIBILITY OF THE SERVICE WITH YOUR OWN COMPUTER EQUIPMENT
          PRIOR TO USE; AND(II) TAKE REASONABLE PRECAUTIONS TO PROTECT YOURSELF
          AGAINST HARMFUL PROGRAMS OR DEVICES INCLUDING THROUGH INSTALLATION OF
          ANTI-VIRUS SOFTWARE.{" "}
        </p>
        <br />
        <p>14. Gambling By Those Under Age</p>
        <br />
        <p>
          {" "}
          ...
          have been betting as an agent for or at the behest of a person under
        ...
        <br />
        <p>
          iii. any monies deposited in your Magic365.live account which are not
        ...
        <p>
          {" "}
          It is the policy of Magic365 to actively prevent the services of the
        ...
        <p>
          ...
          requirements, and to preserve the reputation of the Magic365 against
          the damage that could be caused by being implicated in money
        ...
        <br />
        <p>
          • Commercial considerations cannot take precedence over Magic365
        ...
        <p>
          ...
          Officer/Nominated Officer (“MLRO”), and a deputy to cover in their
          absence, and they shall be afforded every assistance and cooperation
          by all members of staff in carrying out their duties and
          responsibilities. The deputy will be the Director Chief Executive
          Officer (CEO).{" "}
        </p>
        <br />
        <p>
          Magic365 will strictly comply with all applicable AML/CFT rules and
        ...
        <br />
        <p>
          • A commitment to ensuring that customer’s identities will be
          satisfactorily verified at required thresholds;
        </p>
        <br />
        <p>
          {" "}
          • A commitment to “knowing its customer” appropriately - both at
          acceptance and throughout the business relationship - through taking
          appropriate steps to verify the customer’s identity and monitoring
          their use Magic365 services;{" "}
        </p>
        <br />
        <p>
          {" "}
          • A commitment to ensuring that staff are trained and made aware of
          the law and their obligations under it, and to establishing procedures
        ...
        <p>
          ...
          Magic365 and ensuring adequate resources are provided for the proper
        ...
        <p>
          ...
          the Gaming Control Board, Belize. First point of contact for all
        ...
        <br />
        <p>
          Magic365 has appointed a MLRO with full responsibility for VELKI’s
        ...
        <p>
          {" "}
          • Will monitor the day-to-day operation of Magic365 TRADING’s AML/CFT
          policies and respond to any reasonable request made by the law
          enforcement and/or the Gaming Control Board, Belize.{" "}
        </p>
        <br />
        <p>
          {" "}
          ...
          Board, Belize and appropriate law enforcement agencies, in order that
        ...
        <br />
        <p>
          • Is from a senior level and has direct access to senior management
        ...
        <p>
          ...
          the senior management of Magic365 on the operation and effectiveness
          of the money laundering controls. This report will cover improvements,
        ...
        <p></p>
        <br />
        <p>15.4 Compliance Policies and Procedures</p>
        <br />
        <p>
          Magic365 has policies and procedures to assess the risks related to
        ...
        <br />
        <p>• Approved by senior management</p>
        <br />
        <p>
          {" "}
        ...
        <p>
          ...
          placed upon them, their staff and Magic365 itself.{" "}
        </p>
        <br />
        <p></p>
        <br />
        ...
        <p>
          ...
          business relationships, geographic locations, and any other relevant
          factors) that are more vulnerable to abuse by money launderers and
          criminals;{" "}
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          VELKI’s risk tolerance level;{" "}
        </p>
        <br />
        <p>
          {" "}
          • Implementing a process to exit from an existing high-risk
          relationship which management sees as exceeding VELKI’s risk tolerance
          level.{" "}
        </p>
        <br />
        <p>15.4.3 Risk Assessment</p>
        <br />
        <p>
          Magic365 is required to and will analyse potential threats and
        ...
        <br />
        <p>• Products, services and delivery channels</p>
        <br />
        <p>• Geographic locations and areas of operation</p>
        <br />
        <p>• Customers</p>
        <br />
        <p>
        ...
        <br />
        <p>
          Magic365 shall perform an initial risk assessment at the beginning of
          a new customer relationship and for existing customers on an ongoing
          basis.{" "}
        </p>
        <br />
        ...
        <br />
        <p>
          Magic365 will identify products and services or combinations of them
        ...
        <br />
        <p>• Transactions involving third parties;</p>
        <br />
        <p>• Non-face-to-face business relationships.</p>
        <br />
        <p>15.5.2 Geographic Locations and Areas of Operation</p>
        <br />
        <p>
          {" "}
        ...
        <br />
        <p>
          Magic365 does not do business with or provide services to anyone in
        ...
        <p>
          {" "}
          The risk assessment requires to know your customers (“KYC”). This is
          not limited to identification or record keeping, but it is also about
          understanding the customers – including their activities, transaction
          patterns, and how they operate.{" "}
        </p>
        <br />
        ...
        <br />
        <p>• Customers wanting to carry out large transactions;</p>
        <br />
        <p>• Customers with regulatory or enforcement issues;</p>
        <br />
        <p>• Customers with multiple online complaints;</p>
        <br />
        <p>• Customers whose identification is difficult to verify;</p>
        <br />
        <p>• Customers whose who are politically exposed.</p>
        <br />
        <p></p>
        <br />
        <p>
          ...
          risk of money laundering and/or terrorist financing. The rating given
          at the beginning of the business relationship may be adjusted after
          the re-assessment and may change over time. The level of customer due
          diligence will vary depending on the risk rating of the customer at
          the beginning of the relationship and as it changes. For all high-risk
          players, enhanced due diligence is applied right away.{" "}
        </p>
        <br />
        ...
        <br />
        <p>• Failure to train staff adequately;</p>
        <br />
        <p>
        ...
        <br />
        <p>• Failure to report suspicious transactions;</p>
        <br />
        <p>• Not having an MLRO;</p>
        <br />
        <p>• Failing to keep complete customer records.</p>
        <br />
        <p>15.5 Compliance Training</p>
        <br />
        <p>
          Magic365 has a training program for all relevant employees and other
        ...
        <p>
          {" "}
          All new employees of Magic365 are required to complete anti-money
        ...
        <p>
          ...
          member does not understanding the training material, Magic365 will
        ...
        <p>
          {" "}
          Compliance training is adjusted in accordance to the employee’s role
          within the company. The MLRO will review functions and arrange to
        ...
        <p>
          ...
          record keeping requirements as well as penalties for not meeting those
          requirements;{" "}
        </p>
        <br />
        <p>
          {" "}
          • Making all employees aware of the internal policies and procedures
          for deterring and detecting money laundering and terrorist financing
        ...
        <p>
          {" "}
          • Making all employees aware of how Magic365 is vulnerable to abuse by
        ...
        <p>
          ...
          civil proceedings may be brought against them for making a report in
          good faith;{" "}
        </p>
        <br />
        <p>
        ...
        <br />
        <p>15.6. Minimum standards – KYC POLICY</p>
        <br />
        <p>
          Magic365 has established standards regarding Know-Your-Customer
          (“KYC”). These standards require due diligence on each prospective
          customer before entering into a business relationship via
        ...
        <p>
          {" "}
          - Each customer (= each individual person and/or each person involved
          in the case of a legal entity) must be identified by means of original
          supporting documents.{" "}
        </p>
        <br />
        <p>- These documents will be recorded in a centralised system.</p>
        <br />
        <p>- The identification must be completed by "face-to-face" contact.</p>
        <br />
        <p>
          {" "}
        ...
        <br />
        <p>- Each person identified must be registered by IT means.</p>
        <br />
        <p>
          - A person will not be accepted as a customer if the identification
          process proves to be incomplete.
        </p>
        <br />
        <p>
        ...
        <p>
          {" "}
          Concrete application at Magic365 is reflected by a specific
        ...
        <p>
          ...
          exercised with regard to the Customer, a “Compliance” risk profile is
          calculated first of all on entry into relations (Low, Medium, High),
          and is then recalculated daily.{" "}
        </p>
        <br />
        ...
        <p>
          ...
          identify the individual with which Magic365 has a business
        ...
        <br />
        <p>• Determining whether any third parties are involved;</p>
        <br />
        <p>
        ...
        <br />
        <p>• Reviewing their background, reputation;</p>
        <br />
        <p>• Keep records of all information and documents obtained.</p>
        <br />
        <p>15.6.3.2. Identifying Information for Customers</p>
        <br />
        <p>
          {" "}
          This section sets out the standard identification requirements for
          individuals who have entered into a business relationship with
          Magic365. This outline is likely to be sufficient for most situations.
          If, however, the customer is assessed as presenting a higher money
          laundering or terrorist financing risk, in line with our identified
          risk matrix, then Magic365 requires additional identity information to
        ...
        <p>
          ...
          be required to be reasonably satisfied as to the individual’s identity
          will increase. Any concerns must be reported to the MLRO.{" "}
        </p>
        <br />
        <p>
        ...
        <br />
        <p>• Passports and drivers’ licenses should be valid and not expired</p>
        <br />
        <p>• Utility bills should be dated within the last 3 months</p>
        <br />
        <p>
          {" "}
        ...
        <br />
        <p>• Valid photo card driving licence (full or provisional); or</p>
        <br />
        <p>
        ...
        <p>
          ...
          person’s name and residential address or their date of birth. E.g.
          (for proof of address or date of birth):{" "}
        </p>
        <br />
        <p>
        ...
        <br />
        <p>• Current council tax demand letter or statement; or</p>
        <br />
        <p>
          {" "}
        ...
        <p>
          ...
          of the customer’s identity, and that we keep a record of the checks
          made. This will be done by the MLRO or under the supervision of the
          MLRO.{" "}
        </p>
        <br />
        ...
        <br />
        <p>• Do the addresses match the address given on the photo ID?</p>
        <br />
        <p>
          • Does the name of the customer match with the name on the photo ID?
        </p>
        <br />
        <p>15.6.3.3. Identity Verification Triggers</p>
        <br />
        <p>
          {" "}
          Verification of the identity of the customer occurs either when the
          customer has reached the €2,000 threshold or if the player is
          ...
          (or smaller, linked transactions) that reach or exceed €2,000 either
          at deposit or withdrawal stage. For example, transactions will be
          considered as linked when they are carried out by the same customer
          during a single period of being logged on to the Magic365 website or
          if they are carried out in 48 hours.{" "}
        </p>
        <br />
        <p>
          {" "}
          ...
          provided by customers to Magic365 is checked manually by dedicated
          staff.{" "}
        </p>
        <br />
        ...
        <p>
          {" "}
          • When a customer requests a withdrawal to a different account than
          one that was used to make a deposit (e.g. due to the fact that certain
          ...
          deducted from the customer’s account, however, will not be processed
          until the customer’s identity has been verified to ensure that the
        ...
        <p>
          {" "}
          • Registration country and IP do not match – In such cases, the player
          account may not be blocked and the player may still make deposits and
          play games, however, no withdrawal will be allowed until verification
          has been carried out;{" "}
        </p>
        <br />
        <p>• When a deposit exceeds €5,000.</p>
        <br />
        ...
        <p>
          ...
          statement stating the customer’s name and IBAN and the name of the
          bank (for instances when a customer requests a withdrawal to be
          deposited to a bank account);{" "}
        </p>
        <br />
        <p>
          {" "}
          • Proof of Payment Card – This may be a photo or copy of the front
        ...
        <p>
          {" "}
          • To protect the customer’s card data, Magic365 informs them that they
          may obfuscate some of the card details, however, the customer’s name,
          as well as the first and last four digits of the card number must be
          visible.{" "}
        </p>
        <br />
        <p>
          ...
          information available on the customer does not validate the amounts
          being gambled. In such cases Magic365 would ask its higher volume
        ...
        <p></p>
        <br />
        <p>15.6.3.5. Mitigation of Impersonation Risk</p>
        <br />
        <p>
        ...
        <p>
          ...
          the customer’s name with an EU/EEA regulated credit institution or one
        ...
        <p>
          ...
          a home or business number which has been verified (electronically or
        ...
        <br />
        <p>15.6.3.6. Keeping Information Up-to-Date</p>
        <br />
        <p>
          {" "}
        ...
        <br />
        <p>
          Magic365 may review the customer documentation and then update it as
        ...
        <br />
        <p>• First time deposits;</p>
        <br />
        <p>• Cash-out alerts for cash-outs greater than €1,000;</p>
        <br />
        <p>
          • Activity alerts when customer pays to, or stakes with the casino
          €2,000 during any period of 24 hours;
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          Board Belize Policy and the terms and conditions of the Company.{" "}
        </p>
        <br />
        ...
        <p>
          {" "}
          Any member of Magic365 can report suspicious activities to the MLRO,
          as VELKI’s Nominated Officer. A suspicious activity is one where it is
          known, or suspected, there are reasonably grounds to know or suspect
        ...
        <p>
          ...
          must, however, have come to Magic365 during the course of business, or
        ...
        <p>
          ...
          money in relation to the casino or customer’s profile, should receive
          attention, but unusual behaviour should not necessarily lead to
          grounds for knowledge or suspicion of money laundering, or the making
          of a report to the FIAU. The MLRO is required to assess all of the
        ...
        <p>
          ...
          laundering or terrorist financing. “Reasonable grounds to know or
          suspect” introduces an objective test of suspicion. The test is likely
          to be met when there are facts or circumstances, known to the member
          of staff, from which a reasonable person (in a payments firm) would
        ...
        <p>
          ...
          disclosure to the MLRO using the Magic365 Suspicious Transaction
          Report form.{" "}
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          reported to Gaming Control board, Belize. or not, or further enquiries
          made and record its decision and the reason for it in the customer
          files. The member of staff concerned must be informed of the decision
        ...
        <br />
        <p>
          Magic365 must not proceed with a transaction whilst we await consent
        ...
        <br />
        <p>
          Magic365 will examine, as far as reasonably possible, the background
          and purpose of all complex, unusual large transactions, and all
        ...
        <p>
          ...
          anti-money laundering risk indicators or “red flags” that might be
          grounds for suspicion. The list is not exhaustive and not conclusive
          but will be used as a guide for inquiry and follow-up, alongside other
          material.{" "}
        </p>
        <br />
        <p>
        ...
        <br />
        <p>• Information mismatch from application</p>
        <br />
        <p>
        ...
        <br />
        <p>• Inability to provide government issued identification details</p>
        <br />
        <p>
        ...
        <br />
        <p>
          • The address indicated (or corroborated) is identified as mail drop
          or other high-risk address, as opposed to a physical street address
        </p>
        <br />
        <p>• Transaction volume, deposits, and cash-outs are inconsistent</p>
        <br />
        <p>15.7.4.2 Account Settlement</p>
        <br />
        <p>• Large, cross-border wire transfer payments</p>
        <br />
        <p>• Settlements/partial settlements from unrelated third parties</p>
        <br />
        <p>• Excessive/ongoing large credit refunds</p>
        <br />
        <p>15.7.4.3 Transaction and Customer Monitoring</p>
        <br />
        <p>
          {" "}
          • Stakes wagered by a customer become unusually high or out of the
          ordinary and the customer is believed to be spending beyond his or her
          known means. This requires some knowledge of the customer but,
          nevertheless, there may be circumstances that appear unusual and raise
          the suspicion that he is using money obtained unlawfully.{" "}
        </p>
        <br />
        <p>
          {" "}
          ...
          his or her apparent means.{" "}
        </p>
        <br />
        <p>
          • There is no set amount which dictates when a SAR should be made and
          much will depend on what is known, or suspected, about the customer.
        </p>
        <br />
        <p>
          • A customer exhibits unusual gambling patterns with an almost
          guaranteed return or very little financial risk.
        </p>
        <br />
        <p>
          {" "}
          • It is accepted that some customers prefer to gamble in this way but,
          in some instances, the actions may raise suspicion because they are
          different from the customer’s normal gambling practices.{" "}
        </p>
        <br />
        <p>
          • Money is deposited by a customer or held over a period and withdrawn
          by the customer without being used for gambling.
        </p>
        <br />
        <p>
          {" "}
          • For instance, suspicions should be raised by any large amounts
          deposited in gaming machines or gambling accounts that are then cashed
          or withdrawn after very little game play or gambling.{" "}
        </p>
        <br />
        <p>
          • A customer regularly gambles large amounts of money and appears to
          find a level of losses acceptable.
        </p>
        <br />
        <p>
          {" "}
          • In this instance, the customer may be spending the proceeds of crime
          and sees the losses as an acceptable consequence of the process of
          laundering those proceeds.{" "}
        </p>
        <br />
        <p>
          • A customers spend increases over a period of time, thereby masking
          high spend and potential money laundering.
        </p>
        <br />
        <p>
          • A customer spends little, but often, and his annual aggregate spend
          is high and out of kilter with his expected spend.
        </p>
        <br />
        <p>
          {" "}
          • A customer displays gambling patterns where spend is high but the
          risk is low, for example gambling on red and black in roulette. The
          customer could be laundering money in a way that guarantees minimal
          loss.{" "}
        </p>
        <br />
        <p>
          • Instances of high spend by customers that lead to significant
          commercial risk for the operator may also indicate suspicious
          activity.
        </p>
        <br />
        <p>
          {" "}
          Indicators to help establish suspicion that a transaction may be
          related to a terrorist activity financing offence mostly resemble
          those relating to money laundering, although there are some
          differences. For example, amounts relating to terrorist financing
          generally may be smaller.{" "}
        </p>
        <br />
        <p>15.7.4. Financial Sanctions</p>
        <br />
        <p>
          {" "}
          It is the policy of Magic365 to verify the identity of all customers,
          and to check that they are not the subject of sanctions or other
          statutory measures prohibiting the Company from providing its
          services. The member of staff conducting verification of identity will
          complete the process by checking that the customer is not the subject
          of sanctions or other statutory measures, using the screening methods
          set out by the MLRO. These include the direct questions to the
          prospective customer, screening of all new customers against sanctions
          and other databases (via direct reference to an official list or using
          a commercially available product), and ongoing screening of all
          customer names (via ongoing subscription to commercially available
          products and automatic uploads).{" "}
        </p>
        <br />
        <p>15.7.5. Adverse Media</p>
        <br />
        <p>
          {" "}
          Along with Sanctions and PEP databases, third-party providers offer a
          service that screens individuals for adverse media. Magic365 uses such
          a service to identify if a customer has been identified by the media
          as having links to financial crime, terrorist financing and/or other
          criminal activity. These individuals, once confirmed to be one and the
          same in both media and among the Magic365 customers, would only be
          allowed to continue using Magic365 services after a close review by
          the MLRO and/or senior management.{" "}
        </p>
        <br />
        <p>15.8. Anti-Bribery and Whistleblowing</p>
        <br />
        <p>
          {" "}
          As an extension to the AML/CFT efforts, Magic365 also employs
          Anti-Bribery and Whistleblowing Policies and Procedures. These are
          standalone documents that are available to all employees and are part
          of their onboarding package.{" "}
        </p>
        <br />
        <p>15.9. Employee Background Checks</p>
        <br />
        <p>
          Magic365 is committed to establish and maintain procedures which
          enable it to be satisfied as to the integrity of all new staff members
          and by extension their likeliness to follow the Magic365 policies and
          procedures. To meet this requirement, the Human Resource Department is
          responsible for undertaking all of the checks listed in relation to
          new members of staff and for retaining the appropriate records:{" "}
        </p>
        <br />
        <p>• Obtain and confirm references, if required;</p>
        <br />
        <p>
          • Confirm their employment history and the qualifications they have;
        </p>
        <br />
        <p>• Request a recent police conduct certificate; and</p>
        <br />
        <p>• Request details of any regulatory action taken against them. </p>
        <br />
        <p>16. Fraud</p>
        <br />
        <p>
          ...
          payment to any Customer where any of these are suspected. The Customer
          shall indemnify and shall be liable to pay to us on demand, all costs,
          charges or losses sustained or incurred by us (including any direct,
          indirect or consequential losses, loss of profit, loss of business and
          loss of reputation) arising directly or indirectly from the Customer’s
          fraud, dishonesty or criminal act.{" "}
        </p>
        <br />
        <p>17. Responsible Gaming Policy</p>
        <br />
        <p>
        ...
        <br />
        <p>
          VELKI’s Responsible Gambling Policy sets out its commitment to
        ...
        <p>
          ...
          reliability are the guiding principles of VELKI’s work. It is
        ...
        <p>
          ...
          entertainment. Magic365 takes responsibility for such users by
        ...
        <br />
        <p>
          1. The player is deeply involved in gambling, all his thoughts are
          only about the game.
        </p>
        <br />
        ...
        <br />
        <p>
          3. Attempts to quit or control his participation in the games appear
          to be unsuccessful.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          5. Before you start playing, define the maximum amount of winning,
        ...
        <p>
          {" "}
          We trade as Magic365 and the Magic365 name and logo are registered
          trademarks. Any unauthorised use of our trademark and logo may result
          in legal action being taken against you.{" "}
        </p>
        <br />
        <p>
          {" "}
          The&nbsp;www.Magic365.live&nbsp;uniform resource locator (URL) is
          owned by us and no unauthorised use of the URL is permitted on another
        ...
        <p>
          ...
          the Service, our technology, software and business systems (the
          “Systems”) as well as our odds.{" "}
        </p>
        <br />
        <p>
          i. you must not use your personal profile for your own commercial gain
          (such as selling your status update to an advertiser); and
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          logos (the “Marks”) and/or our odds in connection with any product or
          service that is not ours, that in any manner is likely to cause
          confusion among Customers or in the public or that in any manner
          disparages us.{" "}
        </p>
        <br />
        <p>
          {" "}
          Except as expressly provided in these Terms, we and our licensors do
          not grant you any express or implied rights, licence, title or
          interest in or to the Systems or the Marks and all such rights,
          licence, title and interest specifically retained by us and our
          ...
          unauthorised use or reproduction may result in legal action being
          taken against you.{" "}
        </p>
        <br />
        <p>19. Your Licence</p>
        ...
        <p>
          {" "}
          Subject to these terms and your compliance with them, we grant to you
          a non-exclusive, limited, non transferable and non sub-licensable
          licence to access and use the Service for your personal non-commercial
          purposes only. Our licence to you terminates if our agreement with you
          under these Terms ends.{" "}
        </p>
        <br />
        <p>
          {" "}
          Save in respect of your own content, you may not under any
          circumstances modify, publish, transmit, transfer, sell, reproduce,
          upload, post, distribute, perform, display, create derivative works
          from, or in any other manner exploit, the service and/or any of the
          content thereon or the software contained therein, except as we
          expressly permit in these terms or otherwise on the website. No
          information or content on the service or made available to you in
          connection with the Service may be modified or altered, merged with
          other data or published in any form including for example screen or
          database scraping and any other activity intended to collect, store,
        ...
        <p>
          ...
          our or third parties’ intellectual property and other proprietary
          rights which may subject you to civil liability and/or criminal
          prosecution.{" "}
        </p>
        <br />
        <p>20. Your Conduct and Safety</p>
        <br />
        <p>
          {" "}
          We would like you to enjoy the Service. However, for your protection
          and that of all Customers, the posting of any content on the service,
          as well as conduct in connection therewith and/or the service, which
          is in any way unlawful, inappropriate or undesirable is strictly
          prohibited - it is Prohibited Behaviour. If you engage in Prohibited
          Behaviour, or we determine in our sole discretion that you are
          engaging in Prohibited Behaviour, your Magic365.live Account and/or
          your access to or use of the Service may be terminated immediately
        ...
        <p>
          ...
          party, enforcement authorities and/or us with respect to you having
        ...
        <p>
          ...
          to, any activity that furthers or promotes any criminal activity or
          enterprise, provides instructional information about making or buying
          weapons, violates another Customer’s or any other third party’s
          privacy or other rights or that creates or spreads computer viruses;{" "}
        </p>
        <br />
        ...
        <p>
          {" "}
          v. transmit or make available any content that the user does not have
          a right to make available under any law or contractual or fiduciary
          relationship, including without limitation, any content that infringes
        ...
        <p>
          {" "}
          vi. transmit or make available any content or material that contains
          any software virus or other computer or programming code (including
          HTML) designed to interrupt, destroy or alter the functionality of the
          Service, its presentation or any other website, computer software or
          hardware;{" "}
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          advertising or mass mailing such as, but not limited to, junk mail,
          instant messaging, "spim", "spam", chain letters, pyramid schemes or
          other forms of solicitations;{" "}
        </p>
        <br />
        <p>
          xi. create Magic365.live Accounts by automated means or under false or
          fraudulent pretences;
        </p>
        <br />
        <p>xii. impersonate another Customer or any other third party, or</p>
        <br />
        <p>
        ...
        <p>
          ...
          modified by us at any time or from time to time. If you become aware
          of the misuse of the service by another Customer or any other person,
          please contact us through the “Contact Us” section of the Website. We
          reserve the right to investigate and to take all such actions as we in
          our sole discretion deems appropriate or necessary under the
          circumstances, including without limitation, deleting the Customer’s
          posting(s) from the Service and/or terminating their account, and take
          any action against any Customer or third party who directly or
          indirectly in, or knowingly permits any third party to directly or
          indirectly engage in, Prohibited Behaviour, with or without notice to
          such Customer or third party.{" "}
        </p>
        <br />
        <p>21. Links to Other Websites</p>
        <br />
        <p>
          {" "}
          ...
          completeness, accessibility and usefulness. Accordingly when accessing
          such websites we recommend that you should take the usual precautions
          when visiting a new website including reviewing their privacy policy
          and terms of use.{" "}
        </p>
        <br />
        <p>22. Self-exclusion</p>
        <br />
        <p>
          {" "}
          ...
          Self-Exclusion which prevents you gambling with Magic365 for a
          specified period of 6 months, 1 year, 2 years, 5 years or permanently.{" "}
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          your account for any reason, and Magic365 will do all it can to detect
        ...
        <p>
          ...
          suggest that you remove bet365 from your notifications and
          delete/uninstall all Magic365 apps, downloads and social media links.
        ...
        <br />
        <p>
          You can self-exclude your account in the My Gambling Controls section
          of Members by choosing Self-Exclusion.
        </p>
        <br />
        <p>
        ...
        <p>
          {" "}
          Should you opt to self-exclude from Magic365, we strongly recommend
          that you seek exclusion from all other gambling operators you have an
          account with.{" "}
        </p>
        <br />
        <p>
          ...
          or you can exclude from other Northern Territory licensed operators by
          completing a Self-Exclusion Notice form.{" "}
        </p>
        <br />
        <p>
          {" "}
          Once completed the Northern Territory Self-Exclusion Notice form
          should be submitted to the nominated site, sports bookmaker or betting
          exchange operator.{" "}
        </p>
        <br />
        <p>23. Complaints</p>
        ...
        <p>
          {" "}
          Any Customer of the Service who has any concerns or questions
          regarding these Terms regarding the settlement of any Magic365.live
          market should contact our Customer Service Department.{" "}
        </p>
        <br />
        <p>
          {" "}
          If a Customer is not satisfied with how a bet has been settled then
          the Customer should provide details of their grievance to our Customer
          Service Department. We shall use our reasonable endeavours to respond
          to queries of this nature within a few days (and in any event we
          intend to respond to all such queries within 28 days of receipt).{" "}
        </p>
        <br />
        <p>
          {" "}
          Disputes must be lodged within three (3) days from the date the wager
          in question has been decided. No claims will be honored after this
          period. The Customer is solely responsible for their Account
          transactions. Complaints/disputes must be sent from the Customer’s
        ...
        <p>
          ...
          Service Department will attempt to reach an agreed solution. Should
          our Customer Service Department be unable to reach an agreed solution
          with you, the matter will be escalated to our management in accordance
          with our Complaints Procedure (available upon request).{" "}
        </p>
        <br />
        <p>
          {" "}
          The Customer has the right to lodge a complaint with one of our
          licensing bodies should all efforts to resolve a dispute to the
          Customer’s satisfaction have failed.{" "}
        </p>
        <br />
        <p>24. Registration and Account Security</p>
        <br />
        <p>
          {" "}
          Customers of the service must provide their real names and information
          and, in order to comply with this, all Customers must commit to the
          following rules when registering &amp; maintaining your Account:{" "}
        </p>
        <br />
        <p>
          i. you must not provide any false personal information on the Service,
          or create an Account for anyone other than yourself;
        </p>
        <br />
        <p>
          ii. you must not use your personal profile for your own commercial
          gain (such as selling your status update to an advertiser); and
        </p>
        <br />
        <p>
          iii. when selecting a nickname for your Account we reserve the right
          to remove or reclaim it if we believe appropriate.
        </p>
        <br />
        <p>25. Assignment</p>
        <br />
        <p>
          ...
          be assigned by you without the prior written consent of us, which
          consent will not be unreasonably withheld. We may, without your
          consent, assign all or any portion of our rights and obligations
          hereunder to any third party provided such third party is able to
          provide a service of substantially similar quality to the Service by
        ...
        <p>
          ...
          the intention of the original text to the fullest extent permitted by
          applicable law. The validity and enforceability of the remaining
          provisions of these terms shall not be affected.{" "}
        </p>
        <br />
        <p>27. Breach of These Terms</p>
        <br />
        <p>
          {" "}
          Without limiting our other remedies, we may suspend or terminate your
          account and refuse to continue to provide you with the service, in
          either case without giving you prior notice, if, in our reasonable
          opinion, you breach any material term of these Terms. Notice of any
          such action taken will, however, be promptly provided to you.{" "}
        </p>
        <br />
        <p>28. Governing Law and Jurisdiction</p>
        <br />
        <p>
          {" "}
          This Agreement shall in all respects be governed, interpreted by, and
          construed in exclusive accordance with the laws of Belize. All
          disputes, differences, complaints etc., shall be subject to
          Arbitration under the Belize. The arbitrator will be appointed by the
          company after due consent from the company and the user. The place of
          arbitration shall be Belize.{" "}
        </p>
        <br />
        <p>29. General Provisions</p>
        <br />
        <p>
          {" "}
          Term of agreement. These terms shall remain in full force and effect
          while you access or use the service or are a Customer of
          Magic365.live. These terms will survive the termination of your
          Magic365.live Account for any reason.{" "}
        </p>
        <br />
        <p>
          {" "}
          Gender. Words importing the singular number shall include the plural
          and vice versa, words importing the masculine gender shall include the
        ...
        <p>
          {" "}
          Waiver. No waiver by us, whether by conduct or otherwise, of a breach
          or threatened breach by you of any term or condition of these Terms
          shall be effective against, or binding upon, us unless made in writing
          and duly signed by us, and, unless otherwise provided in the written
          waiver, shall be limited to the specific breach waived. The failure of
          us to enforce at any time any term or condition of these Terms shall
          not be construed to be a waiver of such provision or of the right of
          us to enforce such provision at any other time.{" "}
        </p>
        <br />
        <p>
          {" "}
          Headings. The division of these Terms into paragraphs and
          sub-paragraphs and the insertion of headings are for convenience of
          ...
          "these Terms", "hereof", “hereunder” and similar expressions refer to
          these Terms and not to any particular paragraph or sub-paragraph or
          ...
          references herein to paragraphs and sub-paragraphs are to paragraphs
        ...
        <p>
          ...
          paragraph of these Terms. As a result, you hereby irrevocably waive
          any future argument, claim, demand or proceeding to the contrary of
        ...
        <p>
          ...
          version, the English language version will be deemed to be correct.{" "}
        </p>
        <br />
        <p>
          {" "}
          Restricted countries: Magic365 is one of the largest bookies in the
          world and also one of the best known, but this bookmaker does not
          operate in all countries of the world due to restrictions by the
          governments of each country. Therefore, our service is restricted in
          the following countries: Australia, Aruba, Bonaire, Belize, France,
          The Netherlands, Saba, Statia, St. Maarten, Singapore, Spain, the
          United Kingdom, the USA and any other jurisdiction that the Central
          Government of Belize deems online gambling illegal. This includes all
          of the named Nations' Territories and Possessions.{" "}
        </p>
        <br />
        <p>
          {" "}
          Entire agreement. These Terms constitute the entire agreement between
          you and us with respect to your access to and use of the Service, and
          supersedes all other prior agreements and communications, whether oral
        ...
        <br />
        <p>
          Any dispute related to the sports betting product shall be contacted
        ...
        <br />
        <p>
          Any dispute related to the casino product shall be contacted with
          customer support
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          willing to abide by the above Terms and Conditions.
        </p>
        <br />
      </div>
    </React.Fragment>
